...
///
/// --> Excisitng hit adds up all energy depositions in a layer
/// --> ProcessHits() runs at every step, updating the existing hit instead of making new ones
/// --> An extra hit accounts for the total energy in ALL layers
